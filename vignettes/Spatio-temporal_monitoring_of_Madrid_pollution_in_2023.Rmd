...
```{r}
pollutants <- system.file('extdata/pollutants.csv',package = 'widepollution')|> read.csv(sep=',',fileEncoding = "UTF-8")
...
stations <- read.csv(file_path,sep=';')
...
neigh_metadata <- system.file('extdata/neighborhoods_metadata.csv',package='widepollution')|> read.csv(sep = ',')
...
neighborhoods$geometry|>sf::st_transform(crs=neighborhoods_crs)|>
